...
@section('content')
 ...
 <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
 <form class="user" action="{{ url('/ventas_seleccion') }}" id=ventas_seleccion method=POST>
      @csrf
       ...
       <div class="form-group row" id=fechas >
            ...
            <div class="col-sm-3">
              ...
              <a href="#"  onclick="document.getElementById('ventas_seleccion').submit();" class="btn btn-success btn-icon-split">
