...
@section('content')
 ...
 <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Ranking de Productos más Vendidos </h1>
          <p class="mb-4"></p>
          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">por Cantidad de Productos</h6>
            </div>
            <div class="card-body">
 <form class="user" action="{{ url('/estadistica_productos_seleccion') }}" id=estadistica_productos_seleccion method=POST>
      @csrf
       ...
       <div class="form-group row" id=fechas >
            ...
            <div class="col-sm-3">
              ...
              <a href="#"  onclick="document.getElementById('estadistica_productos_seleccion').submit();" class="btn btn-success btn-icon-split">
